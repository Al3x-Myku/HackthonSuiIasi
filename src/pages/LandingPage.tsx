  ...
  return (
    <div
      className={`min-h-screen font-sans antialiased transition-colors duration-200 ${
        isDark ? "dark bg-[#0B1121] text-white" : "bg-gray-100 text-gray-900"
      }`}
    >
      {/* Navigation */}
      <nav
        className={`fixed top-0 w-full z-50 border-b backdrop-blur-md ${
          isDark ? "border-[#2d3748] bg-[#151e32]/90" : "border-gray-200 bg-white/90"
        }`}
      >
      ...
      <main className="relative min-h-screen flex items-center justify-center pt-16 pb-24 overflow-hidden">
        {/* Grid Background */}
        <div
          className={`absolute inset-0 pointer-events-none ${isDark ? "opacity-100" : "opacity-50"}`}
          style={{
        ...
        <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-purple-500/10 rounded-full blur-[128px] pointer-events-none" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center py-12">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <h1 className="text-5xl lg:text-6xl font-extrabold tracking-tight leading-tight">
              Verify Reality. <br />
              <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400 bg-clip-text text-transparent bg-[length:200%_auto] animate-pulse">
                Mint the Truth.
              </span>
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4">
              <div className={`flex flex-col items-center lg:items-start gap-2 p-4 rounded-xl border shadow-sm ${isDark ? "bg-[#151e32] border-[#2d3748]" : "bg-white border-gray-200"}`}>
                ...
                <p className={`text-sm text-center lg:text-left ${isDark ? "text-gray-400" : "text-gray-600"}`}>
                  Use our secure camera interface to take authentic photos.
                </p>
              </div>
              ...
              <div className={`flex flex-col items-center lg:items-start gap-2 p-4 rounded-xl border shadow-sm ${isDark ? "bg-[#151e32] border-[#2d3748]" : "bg-white border-gray-200"}`}>
                ...
                <p className={`text-sm text-center lg:text-left ${isDark ? "text-gray-400" : "text-gray-600"}`}>
                  Instant analysis to detect AI generation or manipulation.
                </p>
              </div>
              ...
              <div className={`flex flex-col items-center lg:items-start gap-2 p-4 rounded-xl border shadow-sm ${isDark ? "bg-[#151e32] border-[#2d3748]" : "bg-white border-gray-200"}`}>
                ...
                <p className={`text-sm text-center lg:text-left ${isDark ? "text-gray-400" : "text-gray-600"}`}>
                  Mint a Verified NFT carrying the proof of authenticity.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="absolute -top-12 -right-12 w-24 h-24 bg-blue-500 rounded-full blur-2xl opacity-20 animate-pulse" />

            <div
              id="login-panel"
              className={`p-8 rounded-2xl shadow-2xl relative z-10 w-full max-w-md mx-auto backdrop-blur-xl transition-all duration-300 ${
                isDark ? "bg-[#151e32]/70 border border-white/10" : "bg-white/80 border border-gray-200"
              }`}
            >
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold mb-2">Welcome Back</h2>
                <p className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"}`}>
                  Connect your wallet to access your gallery and mint new proofs.
                </p>
              </div>

              <div className="space-y-6">
                <ConnectButton className="!w-full !flex !items-center !justify-center !gap-3 !p-4 !rounded-xl !border-2 !border-primary !bg-primary hover:!bg-primary-hover !text-white !font-bold !text-base !transition-all !duration-300 !shadow-lg !shadow-primary/30 hover:!shadow-primary/50 hover:!scale-[1.02]" />

                <div className="flex items-center gap-4">
                  <div className={`h-px flex-1 ${isDark ? "bg-[#2d3748]" : "bg-gray-200"}`} />
      ...
      {/* Footer (no socials) */}
      <footer
        className={`fixed bottom-0 w-full border-t py-4 backdrop-blur-sm z-40 ${
          isDark ? "border-[#2d3748] bg-[#0B1121]/90" : "border-gray-200 bg-white/90"
        }`}
      >
        <div
          className={`max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center text-xs ${
